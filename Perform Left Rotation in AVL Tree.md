# Ex. No: 16E - Perform Left Rotation in AVL Tree and Insert 

## AIM:
To write a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element 'n' into it by getting from input.
...
### Step 6: Insert the key `'n'` using the `insert()` method. If it causes imbalance, perform appropriate rotation.
...
## OUTPUT
![image](https://github.com/user-attachments/assets/98696ff4-4d08-4a85-b08f-98e52f06c577)

## RESULT
Thus a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert an element is implemented successfully.
